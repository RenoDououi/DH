...
# notice:檔名 第一一一回_.txt 回後面有一個空格
    with open("../pyt/RBD/第%s回 .txt" %(chpt), "r", encoding='UTF-8') as f1:
        ...
        #「笑」的分類：7a為有「笑」字的笑，7b為沒有「笑」字的笑，7c為有爭議的笑。
        re7a = {1:'笑'}
        re7b = {1:'忍俊不禁', 2:'哂', 3:'哄堂', 4:'哄然', 5:'春風滿面', 
                6:'捧腹', 7:'絕倒', 8:'喜形於色', 9:'喜逐顏開', 10:'開顏',
                11:'解頤', 12:'嫣然',}
        re7c = {1:'前仰後合', 2:'哂', 3:'粲', 4:'樂', 5:'噱', 6:'囅然',}
...
#print("「%s」這個字出現了"%(regex),dysct,"次。") #測試用